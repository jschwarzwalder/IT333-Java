package edu.greenriver.it.printedsort;
...
public class PrintSorted {
    ...
    public static void main(String[] args) {
    	...
    	printSorted(new int[]{}, 0);
    	printSorted(new int[]{0, 1, 1, 0, 0}, -5);
    	printSorted(new int[]{0, 1, 1, 0, 0}, 1);
    	printSorted(new int[]{0, 1, 1, 2, 3}, 3);
    	printSorted(new int[]{9, 0, 7, 6, 5, 4, 3, 2, 1}, 9);
    	printSorted(new int[]{7, 2, 9, 0, 1, 2, 0, 9, 7, 4, 4, 6, 9, 1, 0, 9, 3, 2, 5, 9}, 9);
    }
