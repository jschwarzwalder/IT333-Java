...
public class Algorithm2 {
	...
	public static void main(String[] args) {
		...
		int[] input = {250, 500, 1000, 2000, 25000, 50000, 100000, 200000, 400000, 800000};
	...
	public static int[] randomInts (int lengthOfArray){
		...
		//array that indicates if number has been used previously
		...
		for (int i = 0; i < lengthOfArray; i++){ 			//lenghtofArray *
			...
			//change index in used to be true indicating you'd used that number
			used[number] = true;
